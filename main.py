...
class ClickableImageApp(App):
    def build(self):
        ...
        exercise_button.bind(on_release=self.show_exercise_screen)
        ...
        bicep_curl_button.bind(on_press=self.open_bicep_file)
    ...
    def show_exercise_screen(self, instance):
        self.screen_manager.current = 'exercise'

    def go_back_home(self, instance):
        self.screen_manager.current = 'home'

    def open_pushup_file(self, instance):
        subprocess.Popen(['python', 'test_pushup.py'])

    def open_pullup_file(self, instance):
        subprocess.Popen(['python', 'pullup.py'])

    def open_bicep_file(self, instance):
        subprocess.Popen(['python', 'bicep.py'])
